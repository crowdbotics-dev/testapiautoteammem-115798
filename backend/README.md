...
## Project Structure
    ...
    ├── testapiautoteammem_115798  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_115798`
...
2. Clone this repo and `cd testapiautoteammem_115798`
